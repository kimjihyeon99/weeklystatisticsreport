...
//주행거리 :지난주와 이번주 비교 멘트
List drvment = [
  "이번주에는 지난주보다 덜 운전하셨네요👏\n환경에 큰 도움이 될 거에요🤩",
  "지난주보다 더 적게 달리셨어요~\n시간 날때 드라이브 한번 다녀오세요🚗",
  "주행거리가 지난주보다 감소했네요!\n덕분에 미세먼지 감축에 도움이 되었어요!",
  "지난주보다 이번주에 운전을 더 많이하셨어요!\n안전운전에 주의하세요😉",
  "지난주보다 더 많이 달리셨어요~\n세차한번 하고 오세요🌊  ",
  "주행거리가 지난주보다 증가했네요!\n여행이라도 다녀오신건가요?⛱",
];
                        ...
                        builder: (BuildContext context) {
                          return new Container(
                              ...
                              child: CupertinoAlertDialog(
                                ...
                                content: new Text(
                                    "✔ 일일 평균 연비 정보을 확인할 수 있습니다.\n✔ 이번주와 지난주의 평균 연비 정보를 비교할 수 있습니다."),
                                actions: <Widget>[
                                  new TextButton(
                                    child: Text("확인"),
                                    onPressed: () {
                        ...
                        builder: (BuildContext context) {
                          return new Container(
                              ...
                              child: CupertinoAlertDialog(
                                ...
                                content: new Text(
                                    "✔ 차계부에 기록한 내용을 바탕으로 주간 차트가 제공됩니다.\n✔ 이번주와 지난주의 지출 내역을 비교할 수 있습니다.\n✔ 원형 그래프를 클릭하여 자세한 금액을 확인할 수 있습니다."),
                                actions: <Widget>[
                                  new TextButton(
                                    child: Text("확인"),
                                    onPressed: () {
